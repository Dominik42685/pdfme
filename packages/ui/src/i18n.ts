...
const dictZh: { [key in keyof Dict]: string } = {
  ...
  edit: 'Upraviť',
  plsInputName: 'Zadajte názov',
  fieldMustUniq: 'Názov poľa musí byť jedinečný',
  notUniq: '(Názov nie je jedinečný)',
  noKeyName: 'Bez názvu',
  fieldsList: 'Zoznam polí',
  editField: 'Upraviť pole',
  type: 'Typ',
  errorOccurred: 'Vyskytla sa chyba',
  errorBulkUpdateFieldName: 'Zmeny nemožno odoslať, pretože sa zmenil počet položiek.',
  commitBulkUpdateFieldName: 'Potvrdiť zmeny',
  bulkUpdateFieldName: 'Hromadná aktualizácia názvov polí',
  addPageAfter: 'Pridať stránku za',
  removePage: 'Odstrániť aktuálnu stránku',
  removePageConfirm: 'Naozaj chcete odstrániť túto stránku? Túto akciu nemožno vrátiť späť.',
  'validation.hexColor': 'Zadajte platný hexadecimálny kód farby.',
  'validation.uniqueName': 'Zadajte jedinečný názov.',
  'validation.dateTimeFormat': 'Neplatný formát dátumu a času.',
  'schemas.color': 'Farba',
  'schemas.borderWidth': 'Šírka okraja',
  'schemas.borderColor': 'Farba okraja',
  'schemas.backgroundColor': 'Farba pozadia',
  'schemas.textColor': 'Farba textu',
  'schemas.bgColor': 'Farba pozadia',
  'schemas.horizontal': 'Vodorovne',
  'schemas.vertical': 'Zvisle',
  'schemas.left': 'Vľavo',
  'schemas.center': 'Stred',
  'schemas.right': 'Vpravo',
  'schemas.top': 'Hore',
  'schemas.middle': 'Stred',
  'schemas.bottom': 'Dole',
  'schemas.padding': 'Odsadenie',
  'schemas.text.fontName': 'Názov písma',
  'schemas.text.size': 'Veľkosť',
  'schemas.text.spacing': 'Medzery',
  'schemas.text.textAlign': 'Zarovnanie textu',
  'schemas.text.verticalAlign': 'Vertikálne zarovnanie',
  'schemas.text.lineHeight': 'Výška riadku',
  'schemas.text.min': 'Minimum',
  'schemas.text.max': 'Maximum',
  'schemas.text.fit': 'Prispôsobiť',
  'schemas.text.dynamicFontSize': 'Dynamická veľkosť písma',
  'schemas.text.format': 'Formát',
  'schemas.mvt.typingInstructions':
    'Pridajte premenné napísaním slov v zložených zátvorkách, napríklad',
  'schemas.mvt.sampleField': 'meno',
  'schemas.mvt.variablesSampleData': 'Vzorové dáta premenných',
  'schemas.barcodes.barColor': 'Farba čiarového kódu',
  'schemas.barcodes.includetext': 'Zahrnúť text',
  'schemas.table.alternateBackgroundColor': 'Striedavá farba pozadia',
  'schemas.table.tableStyle': 'Štýl tabuľky',
  'schemas.table.showHead': 'Zobraziť hlavičku',
  'schemas.table.headStyle': 'Štýl hlavičky',
  'schemas.table.bodyStyle': 'Štýl tela',
  'schemas.table.columnStyle': 'Štýl stĺpca',
  'schemas.date.format': 'Formát dátumu',
  'schemas.date.locale': 'Jazyk',
  'schemas.select.options': 'Možnosti',
  'schemas.select.optionPlaceholder': 'Zadajte možnosť',
  'schemas.radioGroup.groupName': 'Názov skupiny',
};
